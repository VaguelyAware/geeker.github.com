...
function beginAnimation()
{
	tl
    .add('f1')
	tl.add(() => {gsap.fromTo('#image1',{ scale: 1 },{ duration: 10, scale: 1.12, ease: "none" });}, "f1")
    ...
    .from('#text1b', {duration:0.5, x:100, autoAlpha:0, rotationZ:0.001, ease:"power2.out"}, "f1+=1.25")
    ...
    .from('#text2a', {duration:0.5, y:10, autoAlpha:0, rotationZ:0.001, ease:"power2.out"}, "f2+=1.2")
    .from('#text2b', {duration:0.5, y:10, autoAlpha:0, rotationZ:0.001, ease:"power2.out"}, "f2+=1.5")

    //CTA
    .fromTo('#cta', {scale:0}, {duration:0.3, scale:1.1, ease:"back.out"}, "f2+=1.8")
	.to('#cta', {duration:0.1, scale:1, ease:"back.out"}, "f2+=2.1")
	.to('#cta', {duration:0.3, width:'84px', ease:"back.out"}, "f2+=2.2")	
	.from('#label_wrap', {duration:0.5, opacity:0}, "f2+=2.2")	
