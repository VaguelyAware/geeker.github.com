...
function beginAnimation()
{
    ...
    .from('#packshot', {duration:1.5, x:-700, rotationZ:0.001, ease:"back.out(0.7)"}, "f2-=0.25")
    .to('#bgrect', {duration:1.5, x:-438, width:438, rotationZ:0.001, ease:"back.out(0.7)"}, "f2-=0.25")
	...
	.to('#cta', {duration:0.3, width:'86px', ease:"back.out"}, "f2+=2.7")	
